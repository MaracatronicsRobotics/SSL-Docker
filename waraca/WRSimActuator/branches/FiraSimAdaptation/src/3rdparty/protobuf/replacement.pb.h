...
class RobotReplacement final :
 ...
 public:
  ...
  explicit constexpr RobotReplacement(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class BallReplacement final :
 ...
 public:
  ...
  explicit constexpr BallReplacement(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class Replacement final :
 ...
 public:
  ...
  explicit constexpr Replacement(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void Replacement::set_allocated_ball(::fira_message::sim_to_ref::BallReplacement* ball) {
  ...
  if (ball) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::fira_message::sim_to_ref::BallReplacement>::GetOwningArena(ball);
    if (message_arena != submessage_arena) {
